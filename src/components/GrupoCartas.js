    ...
    return (
        <div>
          ...
          <Card 
           ...
           botonSuma={sumarBoton}
           botonResta={restarBoton}
           imagen={carrito}
           postTitle="prueba 1"
         ...
         date="1 year ago"
         imagen={carrito}
         valorInicial={valorIni3}
         botonSuma={sumarBoton3}
         botonResta={restarBoton3}
         postTitle="prueba 1"
